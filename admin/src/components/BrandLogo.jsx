  ...
  const content = (
    <>
      ...
      <span className='text-left leading-none'>
        ...
        {!compact && <span className='mt-1 block text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-500'>Enterprise console</span>}
      </span>
    </>
  )

  return onClick ? (
    <button type='button' onClick={onClick} className='flex items-center gap-3' aria-label='Go to MedFlow AI portal home'>
      {content}
    </button>
