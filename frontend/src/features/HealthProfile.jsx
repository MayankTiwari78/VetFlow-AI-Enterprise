  ...
  return (
    <main className='py-10'>
      <section className='mb-7 flex flex-col justify-between gap-5 border-b border-line pb-7 sm:flex-row sm:items-end'>
        <div><p className='mf-eyebrow'>Private pet owner record</p><h1 className='mf-title'>Health profile</h1><p className='mf-copy'>Keep essential health, emergency, and insurance details ready for authorized veterinary care teams.</p></div>
      ...
      {!editing ? (
        <div className='space-y-5'>
          ...
          <section className='grid gap-5 lg:grid-cols-[1.25fr_1fr]'>
            <article className='mf-card p-6'><p className='mf-eyebrow'>Notes for veterinary care teams</p><p className='mt-4 whitespace-pre-wrap text-sm leading-7 text-slate-600'>{profile.medicalNotes || 'No pet owner-provided medical notes yet.'}</p></article>
